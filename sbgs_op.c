...
/*----------------max & min of the series--------
  ...
  //  printf("%f \n", syn_error[k]);
   ...
   //  getsum1(zz,nn);
      fprintf(fp1,"%20.12lf   %20.12lf   %20.20lf   %20.20lf\n",eps ,ag_syn/8.0, ag_syn*(ag_syn/8.0), (4.0*ag_syn)/(float)(3.0*M_PI*M_PI*M_PI));
  }
